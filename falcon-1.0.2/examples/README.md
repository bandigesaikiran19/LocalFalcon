...
kubectl -n orderer create secret generic initialpeerorg-secret --from-literal=user=ica-initialpeerorg --from-literal=password=icainitialpeerorgSamplePassword
kubectl -n org1 create secret generic org1-secret --from-literal=user=ica-org1 --from-literal=password=icaorg1peerorgSamplePassword
kubectl -n org2 create secret generic org2-secret --from-literal=user=ica-org2 --from-literal=password=icaorg2peerorgSamplePassword
...
sha256 :7c83030bdb05a4a4864f3d1d96afa2dc33d8ad0709c8485a12b5e895ef80c82d  basic-chaincode_go_1.0.tar.gz 
```
